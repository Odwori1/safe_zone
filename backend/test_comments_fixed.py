...
async def test_comments_fixed():
    print("🧪 TESTING FIXED COMMENTS CRUD")
    print("=" * 50)
    ...
    try:
        ...
        update_data = type('CommentUpdate', (), {
            'content': 'Updated comment content'
        })()
        
        updated = await comment_crud.update(comment_id, real_user_id, update_data, real_user_id)
...
asyncio.run(test_comments_fixed())
