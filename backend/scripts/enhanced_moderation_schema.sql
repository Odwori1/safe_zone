-- Enhanced Moderation Schema Updates for Phase 3, Item 6
...
-- Create a view for moderation dashboard (optional but useful)
...
GROUP BY r.id, r.title, r.created_by, u.username, r.current_participants, r.is_locked, r.locked_by, r.locked_at;
