...
import { Users, BookOpen, BarChart3, Heart } from 'lucide-react';
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg border shadow-sm p-6">
                ...
                <div className="space-y-3">
                  ...
                  <button className="w-full text-left p-3 rounded-lg border border-gray-300 hover:border-red-500 hover:bg-red-50 transition-colors">
